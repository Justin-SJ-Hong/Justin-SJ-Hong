...
## 🌟 About Me
단순한 UI 구현이 아니라  
**“왜 느린지, 왜 불편한지”를 해결하는 프론트엔드 개발자**입니다.

- 리뷰 렌더링 구조 개선 → **속도 50% 개선**
- 공통 컴포넌트 설계 → **UI 중복 40% 감소**
- Git Flow 도입 → **협업 충돌 50~60% 감소**

MSA, 커머스, 추천, 커뮤니티 등 다양한 도메인에서  
**27개 기능 · 15개 API를 직접 설계 및 구현**하며  
사용자 경험과 팀 생산성을 동시에 개선해왔습니다.
...
👉 단순 기능 구현이 아니라 **“비즈니스 규칙 기반 UX 통제” 경험**
...
- 렌더링 병목 → 서버 정렬 구조로 변경 → **속도 50% 개선**  
- UI 중복 → 공통 컴포넌트화 → **코드 40% 감소**
- 비동기 타이밍 오류 → 상태 흐름 재설계  
